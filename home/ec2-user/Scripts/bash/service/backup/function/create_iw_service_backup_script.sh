...
function create_iw_service_backup_script() {
    ...
    local iw_backup_template_path=$IW_SCRIPT_CONF_DIR/home/ec2-user/Scripts/bash/service/backup/backup_iw_service.template.sh
    local iw_backup_generated_script_path=$IW_SCRIPT_CONF_DIR/home/ec2-user/Scripts/bash/service/backup/backup_iw_service.$iw_service_name.sh
