...
function download_iw_database_driver() {
    ...
    sudo -u $1 wget --directory-prefix $tomcat_service_user_dir $IW_MARIA_JDBC_DRIVER_URL
    sudo -u $1 wget --directory-prefix $tomcat_service_user_dir $IW_JDBC_DRIVER_WRAPPER_URL
