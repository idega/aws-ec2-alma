...
function create_iw_tomcat_service_root_configuration() {
    local iw_root_template_path=$IW_ALMA_CONFIGURATION_HOME/opt/app/tomcat/conf/Catalina/localhost/ROOT.template.xml
    local iw_root_folder_path=$IW_ALMA_CONFIGURATION_HOME/opt/$1/tomcat/conf/Catalina/localhost
